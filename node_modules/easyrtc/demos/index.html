...
<tr>
    <td><a href="demo_instant_messaging.html">Instant Messaging Demo</a></td>
...
<tr>
    <td><a href="demo_video_only.html">Video Only Demo</a></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_pass.png" /></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_pass.png" /></td>
    <td><img alt="Warn" height="32" width="32" src="images/br_status_fail.png" title="There appears to be a bug in Firefox version 24 with regards to peer connections not sharing video only local media feeds" /></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_fail.png" title="There appears to be a bug in Firefox version 24 with regards to peer connections not sharing video only local media feeds" /></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_fail.png" title="There appears to be a bug in Firefox version 24 with regards to peer connections not sharing video only local media feeds" /></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_pass.png" /></td>
    <td><img alt="Fail" height="32" width="32" src="images/br_status_fail.png" /></td>
    <td><img alt="Fail" height="32" width="32" src="images/br_status_fail.png" /></td>
...
<tr>
    <td><a href="demo_audio_only.html">Audio Only Demo</a></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_pass.png" /></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_pass.png" /></td>
    <td><img alt="Fail" height="32" width="32" src="images/br_status_fail.png" title="There appears to be a bug in Firefox version 24 with regards to peer connections not sharing audio only local media feeds" /></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_fail.png" title="There appears to be a bug in Firefox version 24 with regards to peer connections not sharing audio only local media feeds" /></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_fail.png" title="There appears to be a bug in Firefox version 24 with regards to peer connections not sharing audio only local media feeds" /></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_pass.png" /></td>
    <td><img alt="Fail" height="32" width="32" src="images/br_status_fail.png" /></td>
    <td><img alt="Fail" height="32" width="32" src="images/br_status_fail.png" /></td>
...
<tr>
    <td><a href="demo_audio_video.html">Video+Audio Demo</a></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_pass.png" /></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_pass.png" /></td>
    <td><img alt="Fail" height="32" width="32" src="images/br_status_pass.png" /></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_pass.png" /></td>
...
<tr>
    <td><a href="demo_screen_send.html">Screen sender</a><br>
    <a href="demo_screen_receive.html">Screen receiver</a></td>
    <td><img alt="Fail" height="32" width="32" src="images/br_status_pass.png" /></td>
    <td><img alt="Fail" height="32" width="32" src="images/br_status_pass.png" title="Requires Enable screen capture flag to be set in about:flags" /></td>
    <td><img alt="Fail" height="32" width="32" src="images/br_status_fail.png" /></td>
    <td><img alt="Fail" height="32" width="32" src="images/br_status_fail.png" /></td>
    <td><img alt="Fail" height="32" width="32" src="images/br_status_fail.png" /></td>
    <td><img alt="Fail" height="32" width="32" src="images/br_status_fail.png" /></td>
...
<tr>
    ...
    <td><img alt="Fail" height="32" width="32" src="images/br_status_pass.png" /></td>
    <td><img alt="Warn" height="32" width="32" src="images/br_status_pass.png" title="Requires RTCDataChannel flag to be set in chrome://flags" /></td>
    <td><img alt="Fail" height="32" width="32" src="images/br_status_pass.png" /></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_pass.png" /></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_pass.png" /></td>
    <td><img alt="Pass" height="32" width="32" src="images/br_status_pass.png" /></td>
